...
@Suite("Prefix Modifier Deep Dive")
struct PrefixModifierTests {
    ...
    @Test("Prefix counts characters correctly")
    func testPrefixCharacterCount() throws {
    ...
    @Test("Prefix modifier supports up to 9999")
    ...
    @Test("Five-digit prefix should fail")
    func testFiveDigitPrefix() {
